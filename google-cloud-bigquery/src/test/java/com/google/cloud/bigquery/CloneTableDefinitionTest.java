...
public class CloneTableDefinitionTest {
  ...
  private static final CloneTableDefinition CLONETABLE_DEFINITION =
      CloneTableDefinition.newBuilder()
          .setBaseTableId(BASE_TABLE_ID)
          .setCloneTime(CLONE_TIME)
          .build();
  ...
  public void testBuilder() {
    assertEquals(TableDefinition.Type.CLONE, CLONETABLE_DEFINITION.getType());
    ...
    CloneTableDefinition cloneTableDefinition =
        CloneTableDefinition.newBuilder()
            ...
            .setCloneTime(CLONE_TIME)
            .build();
    assertEquals(CLONETABLE_DEFINITION, cloneTableDefinition);
  }

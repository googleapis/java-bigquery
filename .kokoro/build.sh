...
graalvm)
    ...
    mvn -B ${INTEGRATION_TEST_ARGS} \
      ...
      "-Dtest=!com.google.cloud.bigquery.it.ITBigQueryTest#testBQResultSetPaginationSlowQuery+testReadAPIConnectionMultiClose+testReadAPIIterationAndOrder, *ClientTest"
    RETURN_CODE=$?
    ;;
graalvm17)
